...
class MyGridLayout(Widget):
    ...
    #exceldata = ObjectProperty(None)
    apparat = ObjectProperty(None)
    namesatz = ObjectProperty(None)
    ns_pw = ObjectProperty(None)
    app_pw = ObjectProperty(None)
    voic_pw = ObjectProperty(None)
    admin_pw = ObjectProperty(None)
